...
def build(interactive=False, upstream=False, branch=False):
    ...
    try:
        ...
        # Clean up HTML and API documentation folders
        ...
        if branch:
            ...
            display("rsync -av --delete html_/ html")
            os.system("rsync -av --delete html_/ html")
            display("rsync -av --delete html_/ html")
            os.system("rsync -av --delete latex_/ latex")
