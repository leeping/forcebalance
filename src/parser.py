...
tgt_opts_types = {
    ...
    'ints'    : {"shots"              : (-1, 0, 'Number of snapshots; defaults to all of the snapshots', 'Energy + Force Matching', 'AbInitio'),
                 ...
                 "evaluator_n_restarts": (3, 0, 'Maximum number of times to attempt to estimate the reference data set per iteration.', 'OpenFF Evaluator target', 'Evaluator_SMIRNOFF'),
                 },
